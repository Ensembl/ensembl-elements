...
import icon from '../../icons/icon_minus_circle.svg?raw';
...
@customElement('ens-nav-button-zoom-out')
export class NavButtonZoomOut extends LitElement {
  static styles = [
    css`
      :host {
        display: inline-flex;
...
declare global {
  interface HTMLElementTagNameMap {
    'ens-nav-button-zoom-out': NavButtonZoomOut;
  }
}