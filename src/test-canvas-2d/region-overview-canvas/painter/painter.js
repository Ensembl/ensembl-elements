import { GENE_TRACKS_TOP_OFFSET, GENE_HEIGHT, GENE_TRACK_HEIGHT, REGULATORY_FEATURE_HEIGHT, REGULATORY_FEATURE_TRACK_HEIGHT } from '../constants';
import prepareFeatureTracks from './prepareTracks';
...
const paintGeneTracks = ({ tracks, scale, canvasContext }) => {
...
const paintGeneTrack = ({ track, scale, canvasContext, offsetTop }) => {
...
const paintGene = ({ gene, scale, canvasContext, offsetTop }) => {
...
const paintRegFeatureTracks = ({ tracks, scale, canvasContext, offsetTop, featureTypeMap }) => {
...
const paintRegFeatureTrack = ({ track, scale, canvasContext, offsetTop, featureTypeMap }) => {
